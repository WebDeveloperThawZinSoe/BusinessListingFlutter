...
class RegionDetailScreen extends StatefulWidget {
  ...
  RegionDetailScreen({required this.regionId});
...
class _RegionDetailScreenState extends State<RegionDetailScreen> {
  late Future<Map<String, dynamic>> _regionDetails;

  @override
  void initState() {
    super.initState();
    _regionDetails = fetchRegionDetails();
  }

  Future<Map<String, dynamic>> fetchRegionDetails() async {
    try {
      final response = await http.get(
          Uri.parse('https://cryptodroplists.com/api/region/${widget.regionId}')
      );
          ...
          Expanded(
            child: FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                final region = snapshot.data!['category'];
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: 'https://cryptodroplists.com/storage/' + region['icon'],
                          height: 150,
                      ...
                      SizedBox(height: 10),
                      Text(parseHtmlDescription(region['description'] ?? "")),
                      SizedBox(height: 20),
                      Text(
